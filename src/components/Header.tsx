...
export default function Header({ isScrolled, activeSection }: HeaderProps) {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? "py-3 bg-white/85 shadow-lg shadow-blue-900/5 backdrop-blur-xl border-b border-white/70" : "py-5 bg-transparent"}`}
    >
