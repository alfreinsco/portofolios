        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="w-full md:w-1/2 flex flex-col gap-4 md:gap-6">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-2 text-gray-800">
              Saya <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{profile.name}</span>,
              <br/>
              <span className="relative">
                <span className="inline-block animate-typing overflow-hidden whitespace-nowrap border-r-4 border-blue-600 pr-1">{profile.title}</span>
              </span>
            </h1>
            ...
            <div className="mt-6 md:mt-8 flex flex-wrap gap-4 md:gap-6 items-center">
              <div className="text-gray-600 font-medium text-sm md:text-base">Tech Stack:</div>
              <div className="flex gap-3 md:gap-4">
                <img src="/img/icons/react.svg" alt="React" className="h-6 w-6 md:h-8 md:w-8 grayscale hover:grayscale-0 transition-all" />
                <img src="/img/icons/nextjs.svg" alt="Next.js" className="h-6 w-6 md:h-8 md:w-8 grayscale hover:grayscale-0 transition-all" />
                <img src="/img/icons/node.svg" alt="Node.js" className="h-6 w-6 md:h-8 md:w-8 grayscale hover:grayscale-0 transition-all" />
                <img src="/img/icons/typescript.svg" alt="TypeScript" className="h-6 w-6 md:h-8 md:w-8 grayscale hover:grayscale-0 transition-all" />
              </div>
            </div>
          </div>
